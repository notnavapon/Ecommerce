        ...
        <div className="flex-none flex items-center gap-3">
          ...
          {user ? (
              ...
              {user.role === "admin" ? (
                ...
                >
                  <li>
                    <Link
                      to="/setting"
                      className="flex justify-between items-center w-full px-2 py-1 text-white"
                    >
                      Settings
                    </Link>
                  </li>
            ...
            <div className="dropdown dropdown-hover">
              ...
              <ul
                tabIndex={0}
                className="dropdown-content menu bg-base-100 rounded-box p-2 shadow-lg min-w-fit"
              >
                <li>
                  <Link
                    to="/login"
